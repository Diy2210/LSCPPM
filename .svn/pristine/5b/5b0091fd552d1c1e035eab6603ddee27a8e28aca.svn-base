//
//  SOAPfindCustomers.swift
//  LSCPPM
//
//  Created by Vladimir Zabara on 3/16/16.
//  Copyright © 2016 Diy2210. All rights reserved.
//

import UIKit

class SOAPfindCustomers: NSObject, NSXMLParserDelegate {
    ...
    func getData(offset: Int, limit: Int = 10) {
        ...
        "<?xml version='1.0' encoding='UTF-8'?>" +
            ...
            "<ns1:variableNames>" +
            "<ns1:item>name</ns1:item>" +
            "<ns1:item>email</ns1:item>" +
            "<ns1:item>company</ns1:item>" +
            "<ns1:item>country</ns1:item>" +
    ...
    func parser(parser: NSXMLParser, didStartElement elementName: String, namespaceURI: String?, qualifiedName qName: String?, attributes attributeDict: [String : String])
    {
        ...
        if (elementName as NSString).isEqualToString("ns1:customerRecords")
        {
            records = []
            inRecords = true
        }
    ...
    func parser(parser: NSXMLParser, didEndElement elementName: String, namespaceURI: String?, qualifiedName qName: String?)
    {
        ...
        else if !self.inName && !self.inValue {
            // save record field
            if (elementName as NSString).isEqualToString("ns1:variable") {
