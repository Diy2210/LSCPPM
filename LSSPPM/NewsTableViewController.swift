...
class NewsTableViewController: UITableViewController, NSXMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        let decodedData = NSData(base64EncodedString: "PGRpdj5OZXcgdGVzdCBtZXNzYWdlIDEwLjExIDIuOCBidWlsZCBkYXRlIDIwMTYtMDUtMDY8L2Rpdj4=", options: NSDataBase64DecodingOptions(rawValue: 0))
 ...
 */
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = news.objectAtIndex(indexPath.row).objectForKey("contentData") as? String
